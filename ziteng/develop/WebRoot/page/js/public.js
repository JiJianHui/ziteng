...
function loggedIn(name) {
	var html = '<div id="login_status_info" class="l">';
	html += '<img src="/ziteng/page/public/images/20130330A.png"/>收藏紫藤</div>';
	html += '<div class="returnindex"><a href="/">返回首页</a></div>';
	html += '<div class="r">';
	html += '<ul>';
	...
	html += '<li class="rtcr_wh" style="border:0px;"> <a href="/ziteng/page/help.html">帮助中心</a> </li>';
	html += '</ul>';
	html += '</div>';
	return html;
}
...
function setFooter() {
	...
	html += '<li><a target="_blank" href="/help_centers">帮助中心</a></li>';
