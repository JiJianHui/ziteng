function AddEvent() {
    ...
    $("div.preOptions input").click(function() {
        var b = 0;
        "isBulk" == $(this).attr("id") ? (b = 11, "checked" == $(this).attr("checked") ? FillParameter("1," + b, " Group PurchaseHotel") : FillParameter("0," + b, " Group PurchaseHotel")) : (b = 12, "checked" == $(this).attr("checked") ? FillParameter("1," + b, "Pay in advanceMuch more cheaper") : FillParameter("0," + b, "Pay in advanceMuch more cheaper"))
    }),
...
function FillPrice(a) {
    var b = "<p align=center>抱歉,此Hotel" + par.checkInDate + "到" + par.checkOutDate + "期间内暂时无法预订.</p>";
    "true" == a.Result && $(a.Hotel).each(function(c, d) {
        var f, g, h, i, e = '<table class="hotel_room_list" border="0" cellspacing="0" cellpadding="0"><tbody><tr><th width="26%">Room type</th><th width="20%">早餐</th><th width="8%">床型</th><th width="8%">宽带</th><th width="16%">&nbsp;&nbsp;&nbsp;&nbsp;Price</th><th width="12%">房量</th><th width="10%">&nbsp;</th></tr>';
        ...
        }), h && (e += '<tr><td colspan="5" class="boder_0"><span class="liwu_pic"></span></td><td colspan="2" class="ag_r"><a href="javascript:" >查看所有Room type/价格<span class="all_icon"></span></a></td></tr>'), e += 0 / 0, e = e.replace("NaN", ""), i = $("div.hotel_view[hotelid=" + d.HotelId + "] div.hotel_room"), i.html(e), $(".ag_r a", i).click(function() {
...
function FillHotel(a) {
    ...
    return a && null != a && "" != a ? (par.hotelCount = parseInt(a[0].RowCounter), c = "", $(a).each(function(a, d) {
        ...
        c += d.hotelid + ",",
        b += '<div class="hotel_view" hotelid="' + d.hotelid + '">' + '<div class="hotel_cont">' + '<div class="img_box"> <a href="/hotel/hotel_' + d.hotelid + '.html" title="' + d.hotel_name + '" target="_blank"><img src="' + imageurl + '" width="120" height="96" /></a></div>' + '<div class="htext_box"> ' + '<h3 class="htext_box_h2"><a href="/hotel/hotel_' + d.hotelid + '.html" title="' + d.hotel_name + '" target="_blank">' + d.hotel_name + '<span class="star_img star_' + d.star + '"></a></span></h3>' + '<dl class="ito_box"><dt>Hotel位置：</dt><dd>',
        b += d.area_id > 0 ? '<a href="/hotel/area_' + par.cityId + "_" + d.area_id + '.html" title="' + par.cityName + d.area + 'Hotel">' + d.area + "</a> ": "",
        b += d.area_id_xz > 0 ? '<a href="/hotel/xarea_' + par.cityId + "_" + d.area_id_xz + '/" title="' + par.cityName + d.area_xz + 'Hotel">' + d.area_xz + "</a> ": "",
        b += d.xpoint > 0 && d.ypoint > 0 ? '<a href="/hotel/map.asp?hotelid=' + d.hotelid + '&TB_iframe=true&width=600&height=410" title="' + d.hotel_name + 'Map" class="thickbox">Map/交通</a>': "",
        b += par.uid > 0 ? '<span class="sc-but"><a href="javascript:">加入收藏</a></span>': "",
        b += '</dd></dl><dl class="ito_box"><dt>Hotel Address：</dt><dd>' + d.adress + "</dd></dl>",
        ...
        b += d.IsBulk > 0 ? '<div class="tuan_float"><a href="http://tuan.sunnychina.com/tuangou_view_' + d.IsBulk + '.html" target="_blank"><span></span>Only' + parseInt(d.BulkPrice) + "元</a></div>": "",
        b += d.min_price > 0 ? '<span class="jiage">£' + d.min_price + "</span>起<br />": "",
        b += d.order_count > 0 ? '<div class="hpl_cs">最近已有' + d.order_count + "人预订</div>": "",
        b += d.CountReview > 0 ? '<div class="hpl_cs"><a href="/hotel/hotelReview_' + d.hotelid + '.html" target="_blank" title="Good Reviews率数据来源于艺龙旅行网"><span class="font_16b">' + d.ReviewRate + '%</span>Good Reviews</a> | <a href="/hotel/hotelReview_' + d.hotelid + '.html" target="_blank" title="' + d.hotel_name + '怎么样" class="col_3">' + d.CountReview + "人评价</a></div>": "",
        b += '</div></div><div class="clear"></div></div>',
        b += d.IsBulk > 0 ? '<div class="tuan_nav"><p><a href="http://tuan.sunnychina.com/tuangou_view_' + d.IsBulk + '.html" target="_blank"  title="' + d.hotel_name + ' Group Purchase">【' + par.cityName + "】" + d.BulkDescription + '</a></p><span><input type="button" value=" Group Purchase" name="tuan" onclick="window.open(\'http://tuan.sunnychina.com/tuangou_view_' + d.IsBulk + ".html')\"></span></div>": "",
    ...
    }), TB_init(), ShowPage(), GetPrice(), void 0) : (b = '<div class="hotel_inftip"><ul class="hotel_inftiptx"><li class="mag_b15"><span class="font16_y">很抱歉，</span>没有找到与您的 <strong>筛选条件</strong> 相关的Hotel。。</li><li >建议您适当减少搜索条件：<a href="javascript:" relid="clearAll">清空筛选条件</a></li></ul></div>', par.all = "", $("#hoteldiv").html(b), $("#hoteldiv .hotel_inftiptx li a[relid]").click(function() {
        FillParameter($(this).attr("relid"), "")
...
function SubmitForm() {
    ...
    par.hotelName = "" == $("#HotelName").val() || $("#HotelName").val().indexOf("输入Hotel名") >= 0 ? "": $("#HotelName").val(),
