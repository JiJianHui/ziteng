...
function updateRatio(){
	...
	if(ratio==null || ratio == undefined || ratio == ""){alert("Please type in the 系数值"); return false;}
	if(! /^[1-9]d*.d*|0.d*[1-9]d*|0?.0+|0$/.test(ratio)){alert("Please type in the 浮点数系数值"); return false;}
